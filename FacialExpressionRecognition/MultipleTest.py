...
# iterar sobre todas las imagenes del directorio ./validacion
for filename in os.listdir("./ConjPrueba"):
    
    # cargar la imagen correspondiente, redimensionarla y pasarla a escala de grises
    image = cv2.imread("ConjPrueba/"+filename)
    ...
    for (i, rect) in enumerate(rects):
            ...
            (lex0, ley0) = pointsLE[0] #extremo externo ceja izquierda (no se usa)
